...
class Critic(nn.Module):
    ...
    def __init__(self, state_dim, action_dim):
        ...
        self.encoder_layer1 = nn.TransformerEncoderLayer(d_model=256, nhead=4, dim_feedforward=1024, dropout=0, batch_first=True)
        ...
        self.encoder_layer2 = nn.TransformerEncoderLayer(d_model=256, nhead=4, dim_feedforward=1024, dropout=0, batch_first=True)
