...
while ep < 8000:
    ...
    for i in range(num_eps):
        ...
        np.save('results/returns_curr_noprob.npy', returns_list)
        np.save('results/ep_steps_curr_noprob.npy', ep_steps_list)
        np.save('results/returns_per_veh_curr_noprob.npy', returns_per_veh_list)
