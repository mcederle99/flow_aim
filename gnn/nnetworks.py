...
class Actor(nn.Module):
    def __init__(self, node_dim=3, edge_dim=2, action_dim=1):
        ...
        self.conv1 = gnn.GATConv(64, 64, edge_dim=32)
        self.conv2 = gnn.GATConv(64, 64)
    ...
    def forward(self, x, edge_index, edge_attr):
        ...
        h = f.relu(self.conv1(n, edge_index, e))
...
class Critic(nn.Module):
    def __init__(self, node_dim=3, edge_dim=2, action_dim=1):
        ...
        self.conv3 = gnn.GATConv(64, 64, edge_dim=32)
        self.conv4 = gnn.GATConv(64, 64)
    ...
    def forward(self, data, action, key):
        ...
        h1 = f.relu(self.conv1(n1, edge_index, e1))
        h1 = f.relu(self.conv2(h1, edge_index))
        ...
        h2 = f.relu(self.conv3(n2, edge_index, e2))
        h2 = f.relu(self.conv4(h2, edge_index))
