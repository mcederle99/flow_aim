...
class Actor(nn.Module):
    def __init__(self, node_dim=3, edge_dim=2, action_dim=1):
        ...
        self.conv2 = gnn.GATConv(64, 64, edge_dim=32)
    ...
    def forward(self, x, edge_index, edge_attr, edge_type):
        ...
        h = f.relu(self.conv2(h, edge_index, e))
        h = f.relu(self.conv3(h, edge_index, edge_type, e))
...
class Critic(nn.Module):
    def __init__(self, node_dim=3, edge_dim=2, action_dim=1):
        ...
        self.conv4 = RGCNLayer(64, 64, 2, 32)
        self.conv5 = gnn.GATConv(64, 64, edge_dim=32)
        self.conv6 = RGCNLayer(64, 64, 2, 32)
    ...
    def forward(self, data, action, key):
        ...
        h1 = f.relu(self.conv2(h1, edge_index, e1))
        h1 = f.relu(self.conv3(h1, edge_index, edge_type, e1))
        ...
        h2 = f.relu(self.conv4(n2, edge_index, edge_type, e2))
        h2 = f.relu(self.conv5(h2, edge_index, e2))
        h2 = f.relu(self.conv6(h2, edge_index, edge_type, e2))
