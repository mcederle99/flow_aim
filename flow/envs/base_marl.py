...
class Env(gym.Env, metaclass=ABCMeta):
    ...
    * compute_reward
    ...
    def step(self, rl_actions, old_state):
        ...
        if self.env_params.clip_actions:
            ...
            reward = self.compute_reward(rl_actions, old_state, fail=crash)	# THIS LINE
        else:
            reward = self.compute_reward(rl_actions, old_state, fail=crash)	# THIS LINE
    ...
    def compute_reward(self, rl_actions, state, **kwargs):	# THIS LINE
