...
from networks_bn import Actor, Critic
...
class TD3(object):
    ...
    def train(self, replay_buffer, ep_steps, batch_size=256):
        ...
        for _ in range(ep_steps):
            ...
            if self.total_it % self.policy_freq == 0:
                ...
                # Compute actor losse
                actor_loss = self.critic.Q1(state, self.actor(state).masked_fill(mask == 0, 0.0))
                actor_loss = actor_loss.masked_fill(mask == 0, 0.0)
