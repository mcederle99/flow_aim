...
class Critic(nn.Module):
    def __init__(self, ego_state_dim, action_dim):
        ...
        self.bn1_q1 = nn.BatchNorm1d(1024)
        self.fc2_q1 = nn.Linear(1024, 1024)
        self.bn2_q1 = nn.BatchNorm1d(1024)
        self.fc3_q1 = nn.Linear(1024, 512)
        self.bn3_q1 = nn.BatchNorm1d(512)
        self.fc4_q1 = nn.Linear(512, 256)
        self.bn4_q1 = nn.BatchNorm1d(256)
        ...
        self.bn1_q2 = nn.BatchNorm1d(1024)
        self.fc2_q2 = nn.Linear(1024, 1024)
        self.bn2_q2 = nn.BatchNorm1d(1024)
        self.fc3_q2 = nn.Linear(1024, 512)
        self.bn3_q2 = nn.BatchNorm1d(512)
        self.fc4_q2 = nn.Linear(512, 256)
        self.bn4_q2 = nn.BatchNorm1d(256)
    ...
    def forward(self, state, action):
        ...
        # MLP part
        x_q1 = F.relu(self.bn1_q1(self.fc1_q1(hx_q1)))
        x_q1 = F.relu(self.bn2_q1(self.fc2_q1(x_q1)))
        x_q1 = F.relu(self.bn3_q1(self.fc3_q1(x_q1)))
        x_q1 = F.relu(self.bn4_q1(self.fc4_q1(x_q1)))
        ...
        # MLP part
        x_q2 = F.relu(self.bn1_q2(self.fc1_q2(hx_q2)))
        x_q2 = F.relu(self.bn2_q2(self.fc2_q2(x_q2)))
        x_q2 = F.relu(self.bn3_q2(self.fc3_q2(x_q2)))
        x_q2 = F.relu(self.bn4_q2(self.fc4_q2(x_q2)))
