...
aim = TD3(
        ...
        noise_clip=0.5,
        policy_freq=2,
        filename='models/LSTM_AIM_oldrf_bn')
...
np.save('results/returns_oldrf_bn.npy', returns_list)
np.save('results/ep_steps_oldrf_bn.npy', ep_steps_list)
np.save('results/returns_per_veh_oldrf_bn.npy', returns_per_veh_list)
