...
np.save('results/returns_bn.npy', returns_list)
np.save('results/ep_steps_bn.npy', ep_steps_list)
np.save('results/returns_per_veh_bn.npy', returns_per_veh_list)
