...
import numpy as np
import torch
from utils_batch_newrf import flow_params, trim, order_vehicles, evaluate, choose_actions, rl_actions
...
aim_straight = TD3(
        ...
        noise_clip=0.5,
        policy_freq=2,
        filename='models/batch_newrf/LSTM_AIM_straight')
aim_left = TD3(
        state_dim,
        action_dim,
        max_action,
        ...
        noise_clip=0.5,
        policy_freq=2,
        filename='models/batch_newrf/LSTM_AIM_left')
aim_right = TD3(
        state_dim,
        action_dim,
        max_action,
        ...
        noise_clip=0.5,
        policy_freq=2,
        filename='models/batch_newrf/LSTM_AIM_right')
...
np.save('results/batch_newrf/returns.npy', returns_list)
np.save('results/batch_newrf/ep_steps.npy', ep_steps_list)
np.save('results/batch_newrf/returns_per_veh.npy', returns_per_veh_list)
