...
for i in range(num_eps):
    ...
    np.save('results/returns_gru.npy', returns_list)
    np.save('results/ep_steps_gru.npy', ep_steps_list)
    np.save('results/returns_per_veh_gru.npy', returns_per_veh_list)
