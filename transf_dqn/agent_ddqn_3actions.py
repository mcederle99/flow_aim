...
from network_3actions import Qfunc
...
class DQN():
    ...
    def select_action(self, state):
        ...
        if np.random.random() > self.epsilon:
            ...
            action = torch.randint(0, 3, (num_vehs,), dtype=torch.long)
    ...
    def train(self, replay_buffer, batch_size=batch_size):
        ...
        action = F.one_hot(action.to(torch.long), num_classes=3)
        ...
        with torch.no_grad():
            ...
            next_act = F.one_hot(next_act, num_classes=3)
